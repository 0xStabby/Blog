...
_[chatgpt-vim](https://0xStabby/chatgpt-vim) used to generate a working todo app out of html/js_
...
the development process. It was a unique and powerful way to use the tool, and
it allowed me to move much more quickly than I would have been able to on my
own.
