...
Bitcoin is a peer-to-peer system. That means it has no central authority and no central “server” that can be shut down. It is an entirely network-based self-s
